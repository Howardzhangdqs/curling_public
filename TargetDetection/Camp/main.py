...
def CampFilter(circle, src, canny):
    ...
    return MaxIndex, src, canny


if __name__ == '__main__':

    capture = cv2.VideoCapture(r"D:\DEV\Curling\curling_public\videos\target.min.mp4")
    ...
    while ret:
        ...
        if not circle is None:
            ...
            circle, img, canny = CampFilter(circle, img, canny)
            # print(circle)
